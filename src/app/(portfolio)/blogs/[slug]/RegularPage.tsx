		...
		<div className={`${styles.section} ${ptSans.className}`}>
			<div className={styles.container}>
				...
				<div className='w-full px-4 sm:px-0 flex items-center gap-2'>
					...
					<span className='font-light hidden md:inline-block lg:hidden '>{post.title.slice(0, 20)}...</span>
				...
				{post?.conclusion?.length && (
					<article className='w-full p-4 pb-0 md:p-6 md:pb-0 bg-light-green rounded-2xl text-dark-blue'>
						<h2
							id='conclusion-conclusion-123'
							className='w-full mb-4 sm:mb-5 md:mb-6 lg:mb-7 font-semibold leading-normal text-grey-950 text-[24px] sm:text-[28px] md:text-[32px] lg:text-[35px]'
						>
							Conclusion
						</h2>
